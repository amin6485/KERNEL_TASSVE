...
@ /opt/arm-2009q3/bin/../lib/gcc/arm-none-eabi/4.4.1/ -isysroot
@ /opt/arm-2009q3/bin/../arm-none-eabi -D__USES_INITFINI__ -D__KERNEL__
@ -D__LINUX_ARM_ARCH__=6 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(bounds) -DKBUILD_MODNAME=KBUILD_STR(bounds)
@ -DDEBUG_HASH=49 -DDEBUG_HASH2=5 -isystem
@ /opt/arm-2009q3/bin/../lib/gcc/arm-none-eabi/4.4.1/include -include
...
.LASF50:
	.ascii	"/home/kissingmylove/kernel/common\000"
.LASF29:
